...
class AutoAttack:
    ...
    def return_pc(self):
        ...
        self.text = "Pressed 6 to return to PC."
        self.text_flag = 1

        while True:
            if self.pokeDll.getMap() == 122:
                self.text = "已返回PC，开始进行进一步操作"
                self.text_flag = 1
                time.sleep(6)
